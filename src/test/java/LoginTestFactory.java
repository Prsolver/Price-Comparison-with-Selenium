...
public class LoginTestFactory {
    ...
    public Object[] createInstances() {
        return new Object[] {
                new LoginTest("1354*****", "0123698745doruk", true), // Geçerli kullanıcı adı ve şifre
                new LoginTest("wrongusername", "wrongpassword", false), // Geçersiz kullanıcı adı ve şifre
                new LoginTest("1354*****", "wrongpassword", false), // Geçerli kullanıcı adı ve yanlış şifre
                ...
                new LoginTest("13547*****", " ", false), // Boş şifre
                new LoginTestChrome("1354*****", "0123698745doruk", true), // Chrome'da geçerli kullanıcı adı ve şifre
                new LoginTestChrome("wrongusername", "wrongpassword", false), // Chrome'da geçersiz kullanıcı adı ve şifre
                new LoginTestChrome("1354*****", "wrongpassword", false), // Chrome'da geçerli kullanıcı adı ve yanlış şifre
                ...
                new LoginTestChrome("135473*****", " ", false) // Chrome'da boş şifre
        };
    }
}
